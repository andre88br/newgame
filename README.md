...
| Canastra | brasileira, de dois a quatro (a quatro em duplas), dois baralhos e quatro curingas, treze cartas, morto único e só até três jogadores; jogo normal é **sequência** do mesmo naipe (4 ao ás, no máximo um curinga), **trinca** só depois da primeira canastra da dupla, e dá para trocar o curinga de uma sequência pela carta exata que ele representa; canastra limpa é canastra sem **dois** (o coringa não suja) e rende +100 por carta além da sétima; **três vermelho** (100 só com canastra) e **três preto** (tranca o lixo, nunca entra em jogo, −100 na mão); batida vale 50, inclusive ao pegar o morto; partida até 3000 |
